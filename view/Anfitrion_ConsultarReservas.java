 ...
 * @author pablo
 */
public class Anfitrion_ConsultarReservas extends javax.swing.JFrame {

    public Anfitrion_ConsultarReservas() {
        initComponents();
    }
    ...
    private void jTable1AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jTable1AncestorAdded
        ...
        for (Reserva reserva : reservas) {
            ClienteBase anfitrion = reserva.getInmueble().getAnfitrion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Anfitrion_ConsultarReservas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Anfitrion_ConsultarReservas().setVisible(true);
            }
        });
    }
